...
function FindMyGantryCrane()
	...
	local nearbyFiling = Find(this,"Limo2FilingCabinetPreview",50)
	if next(nearbyFiling) then
		for thatFiling, dist in pairs(nearbyFiling) do
			if thatFiling.HomeUID == this.HomeUID and thatFiling.Id.i ~= this.Id.i then
				thatFiling.Delete()
			end
		end
		--print("Filing Cabinet ok")
		this.Tooltip = "Filing Cabinet ok at x"..this.Pos.x.." y"..this.Pos.y.. "\nXmin "..Xmin.." Xmax "..Xmax.." Ymin "..Ymin.." Ymax "..Ymax
	end
end
